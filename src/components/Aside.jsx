...
const Aside = () => {
  return (
    // <aside className="bg-black w-[107px] flex flex-col items-center">
    <aside className="hidden lg:sticky float-left h-screen w-28 bg-black top-0 z-30 flex-col lg:flex items-center">
      <nav className="ico-aside-container w-1/2 mt-[200%] flex flex-col ml-[auto] mr-[auto]">
      ...
      <p className="copyright text-white text-xs -rotate-180 ml-[auto] mr-[auto] vertical-writing mt-[180px]">
